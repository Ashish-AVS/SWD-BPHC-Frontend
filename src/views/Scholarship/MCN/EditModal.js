      ...
      try {
        const fetchData = async () => {
          ...
          if (mcnData.upload instanceof Blob) {
            ...
            const attachedFile = mcnData.upload
            const attachedFileSize = attachedFile.size / (1024 * 1024)
            const attachedFileType = attachedFile.type
    ...
    >
      ...
      >
        {mcnData.name !== undefined
            ...
            <GridItem xs={12} sm={12} md={12}>
              {!edit
                ...
                : <div><InputLabel className={classes.label}>
                  ...
                  <input name='g_img' type='file' style={{ marginTop: '10px' }} onChange={onDocChange} />
                  </div>}
            </GridItem>
            {edit
              ? <GridContainer>
          ...
          : <p>Loading Data... if more than 30sec then refresh</p>}
      </DialogContent>
