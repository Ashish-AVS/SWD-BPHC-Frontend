      ...
      <Accordion>
        ...
        <AccordionDetails>
          <div>
            ...
            <br />
            <div style={{ display: 'flex', justifyContent: 'center' }}><img src={Image1} alt="image can't be loaded" width='400px' /></div>
            <br />
        ...
        <AccordionDetails>
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-start', flexWrap: 'wrap' }}>
              <img style={{ border: 'solid black 1px', marginBottom: '5px', marginRight: '5px' }} src={Image4} alt="image can't be loaded" width='250px' height='550px' />
              <img style={{ border: 'solid black 1px', marginBottom: '5px', marginRight: '5px' }} src={Image5} alt="image can't be loaded" width='250px' height='550px' />
              <img style={{ border: 'solid black 1px', marginBottom: '5px', marginRight: '5px' }} src={Image2} alt="image can't be loaded" width='250px' height='550px' />
              <img style={{ border: 'solid black 1px', marginBottom: '5px' }} src={Image3} alt="image can't be loaded" width='250px' height='250px' />
            </div>
            <br />
            <br />
        ...
        <AccordionDetails>
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
              <img src={Image6} alt="image can't be loaded" width='500px' />
              <img src={Image7} alt="image can't be loaded" width='500px' />
              <img src={Image8} alt="image can't be loaded" width='500px' />
              <img src={Image9} alt="image can't be loaded" width='500px' />
              <img src={Image10} alt="image can't be loaded" width='500px' />
              <img src={Image11} alt="image can't be loaded" width='500px' />
            </div>
